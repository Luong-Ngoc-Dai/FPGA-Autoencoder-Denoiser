...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "denoiser_top.autotvin.dat"
	set constFileTvOut       "denoiser_top.autotvout.dat"
	set constFileHdlTvIn     "denoiser_top.autohdltvin.dat"
	set constFileHdlTvOut    "denoiser_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
