...
//------------------------Parameter----------------------
`define TV_IN_input_r "../tv/cdatafile/c.denoiser_top.autotvin_input_r.dat"
`define TV_IN_output_r "../tv/cdatafile/c.denoiser_top.autotvin_output_r.dat"
...
parameter denoiser_top_continue_addr = 0;
parameter denoiser_top_auto_start_addr = 0;
parameter input_r_data_in_addr = 16;
parameter output_r_data_in_addr = 28;
...
reg  BREADY_reg = 0;
reg [input_r_c_bitwidth - 1 : 0] mem_input_r [input_r_DEPTH - 1 : 0] = '{default : 'h0};
...
assign TRAN_control_write_data_finish = 1 & input_r_write_data_finish & output_r_write_data_finish;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_output_r_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    if(image_mem_output_r[write_output_r_count * four_byte_num  + i]!==output_r_data_tmp_reg) begin
                    write (output_r_data_in_addr + write_output_r_count * four_byte_num * 4 + i * 4, output_r_data_tmp_reg, write_output_r_resp);
                    image_mem_output_r[write_output_r_count * four_byte_num + i]=output_r_data_tmp_reg;
                    end
                end
                process_busy = 0;
