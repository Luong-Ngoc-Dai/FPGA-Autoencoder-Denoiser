...
if {[file isfile denoiser_top.autotvin.dat]} {
	file delete -force denoiser_top.autotvin.dat
}

if {[file isfile denoiser_top.autotvout.dat]} {
	file delete -force denoiser_top.autotvout.dat
}
