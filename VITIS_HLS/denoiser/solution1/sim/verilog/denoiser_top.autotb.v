...
`define AUTOTB_DUT      denoiser_top
`define AUTOTB_DUT_INST AESL_inst_denoiser_top
`define AUTOTB_TOP      apatb_denoiser_top_top
`define AUTOTB_LAT_RESULT_FILE "denoiser_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "denoiser_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_denoiser_top_top
...
`define AUTOTB_TVIN_gmem0  "../tv/cdatafile/c.denoiser_top.autotvin_gmem0.dat"
`define AUTOTB_TVIN_input_r  "../tv/cdatafile/c.denoiser_top.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r  "../tv/cdatafile/c.denoiser_top.autotvin_output_r.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.denoiser_top.autotvin_gmem0.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.denoiser_top.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.denoiser_top.autotvin_output_r.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.denoiser_top.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.denoiser_top.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 5;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 540210;
parameter LENGTH_gmem0 = 784;
parameter LENGTH_gmem1 = 784;
