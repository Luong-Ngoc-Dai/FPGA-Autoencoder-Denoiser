set moduleName denoiser_top_Pipeline_VITIS_LOOP_18_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {denoiser_top_Pipeline_VITIS_LOOP_18_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 16 regular {axi_master 0}  }
	{ sext_ln18 int 63 regular  }
	{ in_buf_V int 16 regular {array 784 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln18", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "in_buf_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln18 sc_in sc_lv 63 signal 1 } 
	{ in_buf_V_address0 sc_out sc_lv 10 signal 2 } 
	{ in_buf_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ in_buf_V_we0 sc_out sc_logic 1 signal 2 } 
	{ in_buf_V_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln18", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln18", "role": "default" }} , 
 	{ "name": "in_buf_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "in_buf_V", "role": "address0" }} , 
 	{ "name": "in_buf_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_buf_V", "role": "ce0" }} , 
 	{ "name": "in_buf_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_buf_V", "role": "we0" }} , 
 	{ "name": "in_buf_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_buf_V", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln18 { ap_none {  { sext_ln18 in_data 0 63 } } }
	in_buf_V { ap_memory {  { in_buf_V_address0 mem_address 1 10 }  { in_buf_V_ce0 mem_ce 1 1 }  { in_buf_V_we0 mem_we 1 1 }  { in_buf_V_d0 mem_din 1 16 } } }
}
