...
using hls::sim::Byte;
extern "C" void denoiser_top(Byte<2>*, Byte<2>*, int, int);
extern "C" void apatb_denoiser_top_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 784;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*2;
  // DUT call
  denoiser_top(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_output_r);
