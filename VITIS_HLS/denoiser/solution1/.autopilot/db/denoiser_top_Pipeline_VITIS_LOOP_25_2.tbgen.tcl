set moduleName denoiser_top_Pipeline_VITIS_LOOP_25_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {denoiser_top_Pipeline_VITIS_LOOP_25_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 1}  }
	{ sext_ln25 int 63 regular  }
	{ out_buf8 int 16 regular {array 784 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln25", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "out_buf8", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem1_WDATA sc_out sc_lv 16 signal 0 } 
	{ m_axi_gmem1_WSTRB sc_out sc_lv 2 signal 0 } 
	...
	{ m_axi_gmem1_RDATA sc_in sc_lv 16 signal 0 } 
	...
	{ sext_ln25 sc_in sc_lv 63 signal 1 } 
	{ out_buf8_address0 sc_out sc_lv 10 signal 2 } 
	{ out_buf8_ce0 sc_out sc_logic 1 signal 2 } 
	{ out_buf8_q0 sc_in sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln25", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln25", "role": "default" }} , 
 	{ "name": "out_buf8_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "out_buf8", "role": "address0" }} , 
 	{ "name": "out_buf8_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_buf8", "role": "ce0" }} , 
 	{ "name": "out_buf8_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "out_buf8", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln25 { ap_none {  { sext_ln25 in_data 0 63 } } }
	out_buf8 { ap_memory {  { out_buf8_address0 mem_address 1 10 }  { out_buf8_ce0 mem_ce 1 1 }  { out_buf8_q0 mem_dout 0 16 } } }
}
