...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out_buf8 \
    op interface \
    ports { out_buf8_address0 { O 10 vector } out_buf8_ce0 { O 1 bit } out_buf8_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'out_buf8'"
}
}
