...
HD_PWD='C:/Nam_3_HK2_2025_2026/Do_an_1/autoencoder/denoiser/denoiser.runs/design_1_denoiser_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_denoiser_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_denoiser_top_0_0.tcl
